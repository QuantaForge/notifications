...
class MailChannel
{
     ...
     *
     * @var \QuantaForge\Contracts\Mail\Factory
     */
    protected $mailer;
     ...
     *
     * @param  \QuantaForge\Contracts\Mail\Factory  $mailer
     * @param  \QuantaForge\Mail\Markdown  $markdown
     * @return void
     */
     ...
     * @param  mixed  $notifiable
     * @param  \QuantaForge\Notifications\Notification  $notification
     * @param  \QuantaForge\Notifications\Messages\MailMessage  $message
     * @return \Closure
     */
     ...
     *
     * @param  \QuantaForge\Notifications\Messages\MailMessage  $message
     * @return \QuantaForge\Mail\Markdown
     */
    ...
    protected function additionalMessageData($notification)
    {
        return [
            ...
            '__quantaforge_notification_queued' => in_array(
                ShouldQueue::class,
     ...
     *
     * @param  \QuantaForge\Mail\Message  $mailMessage
     * @param  mixed  $notifiable
     * @param  \QuantaForge\Notifications\Notification  $notification
     * @param  \QuantaForge\Notifications\Messages\MailMessage  $message
     * @return void
