...
use QuantaForge\Database\Eloquent\Collection as ModelCollection;
use QuantaForge\Database\Eloquent\Model;
use QuantaForge\Notifications\Events\NotificationSending;
use QuantaForge\Notifications\Events\NotificationSent;
use QuantaForge\Support\Collection;
use QuantaForge\Support\Str;
use QuantaForge\Support\Traits\Localizable;
...
class NotificationSender
{
     ...
     *
     * @var \QuantaForge\Notifications\ChannelManager
     */
    protected $manager;
     ...
     *
     * @param  \QuantaForge\Notifications\ChannelManager  $manager
     * @param  \QuantaForge\Contracts\Bus\Dispatcher  $bus
     ...
     *
     * @param  mixed  $notifiables
     * @return \QuantaForge\Database\Eloquent\Collection|array
     */
